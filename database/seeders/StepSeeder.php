...
class StepSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // $bunBoHueCount = count
        foreach ($bunBoHueStep as $step) {
            Step::create([
                'number' => count($bunBoHueStep),
                'foods_id' => $bunBoHueId,
                'content' => $step,
            ]);
        }
        ...
        foreach ($phoGaStep as $step) {
            Step::create([
                'number' => count($phoGaStep),
                'foods_id' => $phoGaId,
                'content' => $step,
            ]);
        }
        ...
        foreach ($banhCanhCuaStep as $step) {
            Step::create([
                'number' => count($banhCanhCuaStep),
                'foods_id' => $banhCanhCuaId,
                'content' => $step,
            ]);
        }
        $bunRieuId = Food::where('name', 'Bún Riêu')->pluck('id')->first();
        foreach ($bunRieuStep as $step) {
            Step::create([
                'number' => count($bunRieuStep),
                'foods_id' => $bunRieuId,
                'content' => $step,
            ]);
        }
        ...
        foreach ($goiCuonStep as $step) {
            Step::create([
                'number' => count($goiCuonStep),
                'foods_id' => $goiCuonId,
                'content' => $step,
            ]);
        }
        ...
        foreach ($comNieuStep as $step) {
            Step::create([
                'number' => count($comNieuStep),
                'foods_id' => $comNieuId,
                'content' => $step,
            ]);
        }
        ...
        foreach ($banhMiChaoStep as $step) {
            Step::create([
                'number' => count($banhMiChaoStep),
                'foods_id' => $banhCanhCuaId,
                'content' => $step,
            ]);
        }
        ...
        foreach ($boLucLacStep as $step) {
            Step::create([
                'number' => count($boLucLacStep),
                'foods_id' => $boLucLacId,
                'content' => $step,
            ]);
        }
        ...
        foreach ($goiDuDuStep as $step) {
            Step::create([
                'number' => count($goiDuDuStep),
                'foods_id' => $goiDuDuId,
                'content' => $step,
            ]);
        }
        ...
        foreach ($poutineStep as $step) {
            Step::create([
                'number' => count($poutineStep),
                'foods_id' => $poutineId,
                'content' => $step,
            ]);
        }
        ...
        foreach ($tacoStep as $step) {
            Step::create([
                'number' => count($tacoStep),
                'foods_id' => $tacoId,
                'content' => $step,
            ]);
        }
